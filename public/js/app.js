...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      {
        staticClass:
          "h-8 inline-flex items-center px-2 py-2 bg-grey-blue hover:bg-grey-blue-light text-grey-blue-dark font-open-sans font-semibold no-underline leading-none text-xs capitalize rounded",
        on: { click: _vm.show }
      },
