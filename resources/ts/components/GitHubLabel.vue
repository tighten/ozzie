<template>
    <a
        ...
        class="mr-1 mt-2 inline-flex items-center rounded-full py-1 pl-1 pr-2 font-sans text-xs font-semibold leading-none no-underline hover:bg-grey-blue-light">
        <span
            class="ml-1"
...
export default {
    ...
    methods: {
        getCorrectTextColor(hex: string): string {
