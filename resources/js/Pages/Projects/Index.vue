<template>
  <layout title="Ozzie">
    <div class="flex items-center justify-between">
      ...
      <a v-if="hacktoberfest" href="https://github.com/search?o=desc&q=label%3Ahacktoberfest+is%3Aopen+type%3Aissue+user%3Atighten&s=created&type=Issues"
         target="_blank"
      ...
      <table class="table-auto rounded-lg shadow w-full">
        <thead class="bg-grey-blue-light border-grey border-b-2 text-left">
          <tr>
            ...
            <th v-if="hacktoberfest" class="text-xs p-4">🎃</th>
          </tr>
        </thead>
        ...
        <tbody class="bg-white rounded-b-lg divide-y divide-smoke">
          <tr v-for="project in projects" :key="project.name">
            ...
            <td v-if="hacktoberfest" class="p-4">
