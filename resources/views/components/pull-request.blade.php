<li class="flex flex-col">
    <div class="flex justify-between">
        <div class="py-6 w-auto">
            ...
            <div>
                <a class="text-indigo no-underline" href="{{ $prData->user->html_url }}" target="_blank" rel="noopener noreferrer">
                    {{ '@' . $prData->user->login }}
                </a>
                |
        ...
        >
            <div class="flex flex-col p-6">
                ...
                <div class="mt-4 flex items-center text-black-lighter @if (! empty($prData->body)) border-b border-grey-blue-light pb-4 @endif">
                    ...
                    <a class="ml-8 flex items-center" href="{{ $prData->html_url }}/commits" target="_blank" rel="noopener noreferrer">
                    ...
                    <a class="ml-8 flex items-center" href="{{ $prData->html_url }}/files" target="_blank" rel="noopener noreferrer">
