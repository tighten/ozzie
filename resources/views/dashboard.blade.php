...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="description" content="Ozzie - Tighten's Open Source Project Dashboard">
        ...
        <meta property="og:description" content="Ozzie - Tighten's Open Source Project Dashboard">

        <meta property="og:image" content="https://ozzie.tighten.co/ozzie-opengraph.png">
        <meta property="og:image:height" content="630">
        <meta property="og:image:width" content="1200">

        <meta name="twitter:site" content="@Tighten">
        <meta name="twitter:creator" content="@Tighten">
        <meta name="twitter:title" content="Ozzie">
        <meta name="twitter:description" content="Ozzie - Tighten's Open Source Project Dashboard">
