...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="description" content="Ozzie - {{ config('app.organiozation')}}'s Open Source Project Dashboard">
        ...
        <meta property="og:description" content="Ozzie - {{ config('app.organiozation')}}'s Open Source Project Dashboard">
        ...
        <meta name="twitter:description" content="Ozzie - {{ config('app.organiozation')}}'s Open Source Project Dashboard">
