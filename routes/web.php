...
Route::get(
    'inertia/projects/{namespace}/{projectName}/issues/{issueNumber}',
    [IssueController::class, 'show']
)->name('issue.show');
Route::get(
    'inertia/projects/{namespace}/{projectName}/prs/{pullRequestNumber}',
    [PullRequestController::class, 'show']
)->name('pull-request.show');
